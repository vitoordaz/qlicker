...
from qlicker.quser import views
...
urlpatterns = patterns('',
    ...
    url(r'^register/error/$', views.registration_error,
        name='registration_error'),
    url(r'^activate/abort/(?P<activation_key>\w+)', views.activation_abort,
        name='activation_abort'),
    url(r'^activate/(?P<activation_key>\w+)', views.activation,
        name='activation'),
