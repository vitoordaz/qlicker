...
define('model/link',['Backbone'], function(Backbone) {
  'use strict';
...
define('collection/link',['Backbone', 'model/link'], function(Backbone, Link) {
  'use strict';
...
define('model/link_stat',['Backbone'], function(Backbone) {
  'use strict';
...
define('view/login',['jquery', 'Backbone', 'underscore.string'], function($, Backbone, s) {
  'use strict';
  return Backbone.View.extend({
    events: {
      submit: 'submit',
